<section class="testimonials section-space" style="background-image:url('{{ asset('frontend/img/testimonial-bg.jpg')}}')">
    <div class="container">
        <div class="row">
                    ...
                    <div class="testimonial-slider">
                        ...
                        <div class="single-slider">
                            ...
                            <p>simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                                ...
                                standard</p><!-- Client Info -->
                            <div class="t-info">
                                <div class="t-left">
                                    <div class="client-head"><img src="{{ asset('frontend/img/testi1.png')}}" alt="#"></div>
                        ...
                        <div class="single-slider">
                            ...
                            <div class="t-info">
                                <div class="t-left">
                                    <div class="client-head"><img src="{{ asset('frontend/img/testi2.png')}}" alt="#"></div>
